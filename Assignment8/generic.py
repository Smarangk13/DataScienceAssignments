...
class labelTrade:
    def __init__(self, tickerName, start = 100):
        self.ticker = tickerName
        self.startingAmount = start

        with open(self.ticker) as f:
            lines = f.read().splitlines()
        # print('opened file for ticker: ', self.ticker)
    ...
    # weekly
    def labelTrading(self, weekly, money=100):
        # money = 100
        shares = 0
        position = None
...
if __name__ == '__main__':
    ticker = "KOLabels.csv"
    startingAmount = 100
    trader = labelTrade(ticker, startingAmount)
